...
export function CardStack<T extends CardStackItem>({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="pointer-events-none absolute inset-x-0 top-6 mx-auto h-32 w-[60%] rounded-full bg-primary/4 blur-3xl"
          aria-hidden="true"
        />
        <div
          className="pointer-events-none absolute inset-x-0 bottom-0 mx-auto h-24 w-[70%] rounded-full bg-black/5 blur-3xl"
          aria-hidden="true"
        />
        ...
        <div className="mt-6 flex items-center justify-center gap-3">
          ...
          {activeItem.href && (
            <Link
              ...
              target="_blank"
              rel="noreferrer"
              className="text-primary/40 hover:text-primary transition ml-1"
    ...
    <div className="relative h-full w-full">
      <div className="absolute inset-0">
        {item.imageSrc ? (
          ...
          <div className="flex h-full w-full items-center justify-center bg-warm-bg2 text-sm text-text-dark/50">
            No image
          </div>
        )}
      </div>
