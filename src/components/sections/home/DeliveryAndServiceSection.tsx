      ...
      <div className="flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="flex-1 w-full lg:w-1/2">
          <FadeIn delay={0.4} direction="right" className="h-full">
            <div className="w-full h-64 sm:h-80 lg:h-full min-h-[320px] rounded-2xl overflow-hidden shadow-lg border border-primary/10 relative">
              <iframe 
              ...
              <a 
                ...
                className="absolute top-4 left-4 bg-white text-primary px-3 py-1.5 rounded-md flex items-center gap-2 font-semibold text-sm shadow-[0_2px_10px_rgba(0,0,0,0.1)] transition-transform hover:scale-105 active:scale-95"
              >
                Open in Maps
                <svg viewBox="0 0 24 24" width="14" height="14" stroke="currentColor" strokeWidth="2.5" fill="none" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg>
              </a>
            </div>
          </FadeIn>
        </div>
