        ...
        <div className="max-w-4xl mx-auto text-center">
          <FadeIn>
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              >
                <Button variant="outline" size="lg" className="w-full sm:w-auto flex items-center justify-center gap-2 border-[#25D366] text-[#25D366] hover:bg-[#25D366] hover:text-white transition-colors">
